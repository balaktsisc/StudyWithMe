...
public class StudyRequest {
    ...
    public StudyRequest(String subject, String reason, String place, String comments, User requestedUser, ArrayList<User> matchedUsers, Date time, PeriodOfStudy period, int maxMatches) {
    ...
    public void setRequestedUsers(User requestedUser) { this.requestedUser = requestedUser; }
